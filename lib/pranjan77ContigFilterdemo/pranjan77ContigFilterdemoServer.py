...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'pranjan77ContigFilterdemo'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from pranjan77ContigFilterdemo.pranjan77ContigFilterdemoImpl import pranjan77ContigFilterdemo
impl_pranjan77ContigFilterdemo = pranjan77ContigFilterdemo(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['pranjan77ContigFilterdemo.filter_contigs_async'] = ['pranjan77ContigFilterdemo', 'filter_contigs']
async_check_methods['pranjan77ContigFilterdemo.filter_contigs_check'] = ['pranjan77ContigFilterdemo', 'filter_contigs']
sync_methods['pranjan77ContigFilterdemo.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'pranjan77ContigFilterdemo'
        ...
        self.rpc_service.add(impl_pranjan77ContigFilterdemo.filter_contigs,
                             name='pranjan77ContigFilterdemo.filter_contigs',
                             types=[dict])
        self.method_authentication['pranjan77ContigFilterdemo.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "pranjan77ContigFilterdemo but no authentication header was passed"
                            raise err
