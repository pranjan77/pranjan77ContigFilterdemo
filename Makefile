SERVICE = pranjan77contigfilterdemo
SERVICE_CAPS = pranjan77ContigFilterdemo
SPEC_FILE = pranjan77ContigFilterdemo.spec
URL = https://kbase.us/services/pranjan77contigfilterdemo
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
